  ...
  return (
    ...
    alignItems: 'center'
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '20px' }}>
          ...
          <Link to="/" style={linkStyle}>Mis Cursos</Link>
      </div>
...
//     <h2 style={{ margin: 0, color: COLORS.PRIMARY }}>Flash⚡Card🃏</h2>
//     <div style={{ display: 'flex', alignItems: 'center', gap: '20px' }}>
//           <h2 style={{ margin: 0, color: COLORS.PRIMARY }}>🧠 Brainscape Clone</h2>
...
//           <button onClick={signOut} style={logoutStyle}>Salir</button>
//       </div>
//   </nav>
// );
           ...
           >
              <Routes>
                 ...
                 <Route
                    ...
                    element={<AdminCourseDetailsScreen />}
                 />
