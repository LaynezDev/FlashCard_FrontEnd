                ...
                <div style={styles.modalOverlay}>
                    <div style={styles.modalContent}>
                        ...
                        <div style={{ marginTop: 20, display: 'flex', gap: 10, justifyContent: 'flex-end' }}>
                            <button onClick={() => setSelectedStudent(null)} style={styles.btnCancel}>Cancelar</button>
                            <button onClick={handleEnroll} style={styles.btnConfirm}>Guardar Inscripción</button>
                        </div>
                    </div>
                </div>
            )}
...
const styles = {
    ...
    modalContent: {
        backgroundColor: '#fff', padding: 30, borderRadius: 10, width: '400px', boxShadow: '0 5px 15px rgba(0,0,0,0.3)'
    },
